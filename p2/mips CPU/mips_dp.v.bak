module mips_dp(clk,rst,RegDst,RegWr,ExtOp,nPC_sel,ALUctr,MemtoReg,MemWr,ALUSrc,j_sel,Instruction,jal_sel,lb_sel,IRWr,sb_sel,PCWr,PrRD,PrWD,PrAddr,Din_sel);
input clk,rst;
input [1:0]ExtOp,nPC_sel;
input [3:0]ALUctr;
input [31:0]PrRD;
input Din_sel;
input ALUSrc,MemWr,MemtoReg,RegDst,RegWr,j_sel,jal_sel,lb_sel,sb_sel,IRWr,PCWr;
